...
if($name && $email && $message){
 ...
 $message_body="Prośba o wycenę wysłana ze strony www.antoniakbudownictwo.pl\n";
 $message_body.="Imię: $name\n";
 $message_body.="Adres email: $email\n";
 $message_body.="Treść: $message";
 if(mail("kontakt@antoniakbudownictwo.pl","Wycena dla firmy Antoniak Budownictwo",$message_body,$headers)){
